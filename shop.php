...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="shop.php" class="logo">RMSuperShop</a>
      ...
      <nav class="navbar" data-navbar>
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="wishlist.php" class="navbar-link" data-nav-link>wishlist</a>
          </li>
      ...
      <div class="header-actions">
        ...
        <?php
         ...
         <a href="cart.php"><ion-icon name="bag-handle-outline" aria-hidden="true"></ion-icon></a>
          ...
          <span class="btn-badge"><span>(<?= $count_cart_items->rowCount(); ?>)</span></span>
        </button>
  ...
  <main>
    <article>
      ...
      <section class="section hero has-bg-image" id="home" aria-label="home"
        style="background-image: url('./images/bg/model35.png')">
        <div class="container">
   ...
   ?>
          ...
          <h1 class="h1 hero-title">
            <span class="span">High Quality</span> Food
          </h1>

          <p class="hero-text">Sale up to 40% off today</p>

          <a href="category.php?category=snacks" class="btn">Shop Now</a>
          ...
          <ul class="has-scrollbar">
            ...
            <li class="scrollbar-item">
              <div class="category-card">
                ...
                <figure class="card-banner img-holder" style="--width: 330; --height: 300;">
                  <img src="./images/bg/riad5.jpg" width="330" height="300" loading="lazy" alt="fashion"
                    class="img-cover">
                </figure>

                <h3 class="h3">
                  <a href="category.php?category=toy" class="card-title">Toy</a>
                </h3>
            ...
            <li class="scrollbar-item">
              <div class="category-card">
                ...
                <figure class="card-banner img-holder" style="--width: 330; --height: 300;">
                  <img src="./images/bg/riad1.jpg" width="330" height="300" loading="lazy" alt="Electronic"
                    class="img-cover">
                </figure>
            ...
            <li class="scrollbar-item">
              <div class="category-card">
                ...
                <figure class="card-banner img-holder" style="--width: 330; --height: 300;">
                  <img src="./images/bg/model39.png" width="330" height="300" loading="lazy" alt="Meat"
                    class="img-cover">
                </figure>
            ...
            <li class="scrollbar-item">
              <div class="category-card">
                ...
                <figure class="card-banner img-holder" style="--width: 330; --height: 300;">
                  <img src="./images/bg/model40.png" width="330" height="300" loading="lazy"
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="offer-card has-bg-image img-holder"
                style="background-image: url('./images/bg/model41.png'); --width: 540; --height: 374;">
                ...
                <a href="category.php?category=fruts" class="btn">Shop Now</a>
            ...
            <li>
              <div class="offer-card has-bg-image img-holder"
                style="background-image: url('./images/bg/riad7.png'); --width: 540; --height: 374;">
            ...
            <li>
              <div class="offer-card has-bg-image img-holder"
                style="background-image: url('./images/bg/riad6.jpg'); --width: 540; --height: 374;">


                <a href="category.php?category=toy" class="btn">Shop Now</a>
   ...
   <form action="" class="box" method="POST">
      <div class="price">TK<span><?= $fetch_products['price']; ?></span>@RMShop</div>
   ...
   ?>
      ...
      <section class="cta has-bg-image" aria-label="cta" style="background-image: url('./images/bg/riad4.png')">
        <div class="container">

          <figure class="cta-banner">
            <img src="./images/bg/ai16.png" width="500" height="500" loading="lazy" alt="cat" class="w100">
          </figure>

          <div class="cta-content">

            <img src="./images/bg/model40.png" width="120" height="35" loading="lazy" alt="taste guarantee"
              class="img">
  ...
  <footer class="footer" style="background-image: url('./assets/images/footer-bg.jpg')">
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2023 Made with ♥ by <a href="#" class="copyright-link">Riadmahamud</a>
        </p>
  ...
  <script type="text/javascript" src="./js/shop_mor.js" defer></script>
